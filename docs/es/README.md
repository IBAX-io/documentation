...
heroImage: /ibax.png
heroText: IBAX
tagline: Una red de infraestructura comercial descentralizada entre cadenas
actionText: Inicio rápido →
actionLink: /es/concepts/about-the-platform.html
features:
- title: Una gran reducción del costo de la aplicación blockchain.
- title: Un ecosistema físico construido de forma independiente
- title: Implementación rápida de servidores distribuidos, entornos de desarrollo y aplicaciones
- title: Una tienda DApp diversificada y una funcionalidad BaaS
