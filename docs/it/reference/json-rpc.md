...
- *Object* - Get the actions request object
    ...
    - **lang** - *String* - [Omitempty](#omitempty) -
        ...
        This field specifies the multilingual resource code or localization, e.g. *en, it*. If the specified multilingual resource is not found, e.g. *en-US*, then search in the Multilingual Resources group, **default**: **en**.
