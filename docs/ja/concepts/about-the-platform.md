...
- [IBAX概要](#ibax概要)
  ...
  - [アーキテクチャ](#アーキテクチャ)
    ...
    - [ブロックとトランザクションの検証](#ブロックとトランザクションの検証)
    - [データベース](#データベース)
  - [ECOLIB](#ecolib)
    - [IDE](#ide)
    - [アプリケーション](#アプリケーション)
    - [テーブル](#テーブル)
    - [エコシステムパラメータ](#エコシステムパラメータ)
  - [アクセス権制御メカニズム](#アクセス権制御メカニズム)
    - [アクセス権管理](#アクセス権管理)
    - [排他的権利](#排他的権利)
  - [仮想プライベートエコシステム](#仮想プライベートエコシステム)
    - [Webリソースへのリクエスト](#Webリソースへのリクエスト)
    - [データの読み取り権限](#データの読み取り権限)
    - [CLBの作成](#CLBの作成)
    - [CLBの使用法](#CLBの使用法)
