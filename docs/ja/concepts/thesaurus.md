...
# 用語と定義
   ...
   - [ブロックチェーン用語](#ブロックチェーン用語)
     - [ブロックチェーン](#ブロックチェーン)
     - [ピアツーピアネットワーク](#ピアツーピアネットワーク)
     - [ハッシュ](#ハッシュ)
     - [ブロック](#ブロック)
     - [ブロック検証](#ブロック検証)
     - [コンセンサス](#コンセンサス)
     ...
     - [二重支出](#二重支出)
     - [暗号化](#暗号化)
     - [プライベートブロックチェーン](#プライベートブロックチェーン)
     - [パブリックブロックチェーン](#パブリックブロックチェーン)
     - [権限の証明](#権限の証明)
   - [IBAX規約](#IBAX規約)
     - [テストネット](#テストネット)
     - [メインネット](#メインネット)
     ...
     - [ウィーバー](#ウィーバー)
     - [エコリブ](#エコリブ)
     - [ECOLIBパラメータ](#ECOLIBパラメータ)
     - [ECOLIBメンバー](#ECOLIBメンバー)
     - [仮想プライベートECOLIB](#仮想プライベートECOLIB)
     - [分散型権限証明](#分散化された権限証明)
     - [針](#針)
     - [ロジコー](#ロジコー)
     - [統合開発環境 (IDE)](#統合開発環境(IDE))
     - [ページエディター](#ページエディター)
     - [ビジュアルページデザイナー](#ビジュアルページデザイナー)
     - [契約編集者](#契約編集者)
     - [多言語リソース](#多言語リソース)
     - [アプリケーションのエクスポート](#アプリケーションのエクスポート)
     - [アプリケーションのインポート](#アプリケーションのインポート)
     - [スマートな法律](#スマートな法律)
     - [法制度](#法制度)
     - [応用](#応用)
     - [ページ](#ページ)
