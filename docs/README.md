...
heroImage: /ibax.png
heroText: IBAX
tagline: A Decentralized Commercial Cross-Chain infrastructure Network
actionText: Quick start →
actionLink: /concepts/about-the-platform.md
features:
- title: A great reduction of blockchain application cost
- title: An independently build physical ecosystem
- title: Quick deployment of distributed servers, development and application environments
- title: A diversified DApp Store and BaaS functionality
- title: Actual service response in seconds
- title: Cross-chain and cross-system data interaction 
- title: A new infrastructure network integrating public, alliance, and rivate chains
